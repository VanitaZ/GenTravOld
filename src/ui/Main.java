...
public class Main extends JFrame implements MapListener, ModelProgressListener, DocumentListener, ActionListener
{
	...
	public Main()
	{
		...
		try
		{
			symbol = ImageIO.read(new File("C:\\Users\\Konrad\\Dysk Google\\uczelnia\\Algorytmy decyzyjne\\aditz\\milestone2\\data\\city.png"));
		}
		catch(Exception ex){}
		...
		try
		{
			highlightedSymbol = ImageIO.read(new File("C:\\Users\\Konrad\\Dysk Google\\uczelnia\\Algorytmy decyzyjne\\aditz\\milestone2\\data\\highlightedCity.png"));
		}
		catch(Exception ex){}
		...
		try
		{
			selectedSymbol = ImageIO.read(new File("C:\\Users\\Konrad\\Dysk Google\\uczelnia\\Algorytmy decyzyjne\\aditz\\milestone2\\data\\selectedCity.png"));
		}
		catch(Exception ex){}
		...
		try
		{
			BufferedReader brin = new BufferedReader(new FileReader("C:\\Users\\Konrad\\Dysk Google\\uczelnia\\Algorytmy decyzyjne\\aditz\\milestone2\\data\\data.txt"));
